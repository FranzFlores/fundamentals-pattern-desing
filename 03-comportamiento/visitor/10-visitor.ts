...
class ChildVisitor implements Visitor {
    ...
    visitHauntedHouse(hauntedHouse: HauntedHouse): void {
        console.log(
            `Niño en Cara del terror: Precio con descuento de ${hauntedHouse.getPrice() * 0.7}`
        );
    }
...
class AdultVisitor implements Visitor {
    ...
    visitHauntedHouse(hauntedHouse: HauntedHouse): void {
        console.log(
            `Adulto en Cara del terror: Precio con descuento de ${hauntedHouse.getPrice()}`
        );
    }
...
class SeniorVisitor implements Visitor {
    visitRollerCoaster(rollerCoaster: RollerCoaster): void {
        console.log(
            `Adulto en Montaña Rusa: Precio con descuento de ${rollerCoaster.getPrice() * 0.85}`
        );
    }

    visitHauntedHouse(hauntedHouse: HauntedHouse): void {
        console.log(
            `Adulto en Cara del terror: Precio con descuento de ${hauntedHouse.getPrice() * 0.85}`
        );
    }

    visitFerrisWheel(ferrisWheel: FerrisWheel): void {
        console.log(
            `Adulto en Rueda de la fortuna: Precio con descuento de ${ferrisWheel.getPrice() * 0.85}`
        );
    }
}
...
const main = () => {
    ...
    console.log('\n%cVisitante adulto mayor', COLORS.blue);
